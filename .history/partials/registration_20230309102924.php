        ...
        <div class="container">
            <form action="">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <input type="text" class="form-control w-50 m-auto" placeholder="Enter your password" required="required" name="mobile">
                </div>

                        <div class="mb-3">
                    <input type="text" class="form-control w-50 m-auto" placeholder="confirm password" required="required" name="mobile">
                </div>
            </form>
        </div>
