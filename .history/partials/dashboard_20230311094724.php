    ...
    <div class="container my-5">
        ...
        <div class="row my-5">
            <div class="col-md-7">
                ...
                if ($_SESSION['status']==1) {
                     ?>
                    <button class="btn rounded-pill bg-success my-4 px-3 text-white">voted</button>
                    <?php
                }else {
            ?>
                    <button class="btn rounded-pill bg-danger my-4 px-3 text-white" type="submit">vote</button>
                    <?php
                }
